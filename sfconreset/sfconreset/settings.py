"""
Django settings for sfconreset project.
...
SECRET_KEY = 'iji)p37^c@_rj5aa5v$sfk1@gz_#d#adqlmk-4!4)nl@m)!sh7'
...
WSGI_APPLICATION = 'sfconreset.wsgi.application'
